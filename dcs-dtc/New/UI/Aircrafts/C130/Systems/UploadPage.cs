...
{
    public UploadPage(C130Page parent) : base(parent, nameof(parent.Configuration.Upload))
    {
        InitializeComponent();
        ...
        chkRoute.CheckedChanged += (s, e) =>
        {
            upload.Route = chkRoute.Checked;
            this.SavePreset();
        };
