...
namespace DTC.UI.Aircrafts.FA18
{
    public partial class AAWeaponsPage : AircraftSettingPage
    {
        ...
        public AAWeaponsPage(AircraftPage parent, AAWeaponsSystem aaweapons) : base(parent)
        {
            ...
            this.Controls.Add(DTCCheckBox.Make(left, top, chkWidth, rowHeight, _aaweapons.AzElToBeUpdated, (chk) =>
            {
            ...
            //AIM9 Row
            {
                ...
                this.Controls.Add(DTCCheckBox.Make(left, top, chkWidth, rowHeight, _aaweapons.AIM9ToBeUpdated, (chk) =>
                {
            ...
            //AIM7 Row
            {
                ...
                this.Controls.Add(DTCCheckBox.Make(left, top, chkWidth, rowHeight, _aaweapons.AIM7ToBeUpdated, (chk) =>
                {
            ...
            //AIM120 Row
            {
                left = padding;
                top += rowHeight + padding;
                this.Controls.Add(DTCCheckBox.Make(left, top, chkWidth, rowHeight, _aaweapons.AIM120ToBeUpdated, (chk) =>
                {
