...
namespace DTC.UI.Aircrafts.FA18
{
    public partial class LoadSavePage : AircraftSettingPage
    {
        ...
        private void chkSaveWaypoints_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void chkLoadRadios_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void chkLoadAAWeapons_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void chkLoadCMS_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void chkLoadPP_CheckedChanged(object sender, EventArgs e)
        {
        }

        private void chkLoadSeq_CheckedChanged(object sender, EventArgs e)
        {
        }
    }
}
