...
function DTC_F16C_GetLeftMFD_Old()
    return DTC_ParseDisplay(4)
end

function DTC_F16C_GetRightMFD_Old()
...
function DTC_F16C_CheckCondition_LeftHdptNotOn()
...
function DTC_F16C_CheckCondition_RightHdptNotOn()
...
function DTC_F16C_CheckCondition_RadioNotBoth()
...
function DTC_F16C_CheckCondition_HARM()
    local table = DTC_F16C_GetDED();
...
function DTC_F16C_CheckCondition_NotInAAMode()
    local table = DTC_F16C_GetDED();
...
function DTC_F16C_CheckCondition_NotInAGMode()
    local table = DTC_F16C_GetDED();
    local str = table["Master_mode"];
    if str == "A-G" then
        return true
...
function DTC_F16C_CheckCondition_HTSOnDED()
    local table = DTC_F16C_GetDED();
...
function DTC_F16C_CheckCondition_HTSOnMFD(mfd)
    local mfdTable;

    if mfd == "left" then
        mfdTable = DTC_F16C_GetLeftMFD_Old();
    else
        mfdTable = DTC_F16C_GetRightMFD_Old();
    end
...
function DTC_F16C_CheckCondition_NotNAVMode()
...
--function DTC_F16C_CheckCondition_CRM(mfd)
--    DTC_Wait()
--    local table = {}
...
--    local str = table["FCR_NotModeMenu_RootAA.2.CRM Table. Root. Unic ID: _id:48.2.CRM Table. Root. Unic ID: _id:48. Text.1"] or "";
--    if str == "CRM" then
--        return true
--    end
--    return false
...
function DTC_F16C_CheckCondition_InCRMMode(mfd, mode)
    local table = {}
...
function DTC_F16C_CheckCondition_FCRAz(mfd, expAz)
    local table = {}
...
function DTC_F16C_CheckCondition_NotAuto(mfd)
    local table = {}
...
function DTC_F16C_AfterNextFrame(params)
    --DTC_DebugDisplay(DTC_LinesToList(list_indication(5)))
    --DTC_DebugDisplay(DTC_F16C_GetRightMFD())
