...
namespace DTC.UI.Aircrafts.AH64
{
    public partial class RadioPage : AircraftSettingPage
    {
        ...
        public RadioPage(AircraftPage parent, RadioSystem radios) : base(parent)
        {
            ...
            var tblUHF = PopulateTable(_radios.UHF);
            var tblVHF = PopulateTable(_radios.VHF);
            var tblFM1 = PopulateTable(_radios.FM1);
            var tblFM2 = PopulateTable(_radios.FM2);

            tblRadios.Controls.Add(tblUHF, 1, 1);
            tblRadios.Controls.Add(tblVHF, 0, 1);
            tblRadios.Controls.Add(tblFM1, 0, 3);
            tblRadios.Controls.Add(tblFM2, 1, 3);
